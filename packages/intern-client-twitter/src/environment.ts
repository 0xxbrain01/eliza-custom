...
export const twitterEnvSchema = z.object({
    ...
    TWITTER_GUEST_ID: z.string().min(1, "X/Twitter guest id is required"),
    TWITTER_KDT: z.string().min(1, "X/Twitter kdt is required"),
    TWITTER_TID: z.string().min(1, "X/Twitter tid is required"),
    TWITTER_CT0: z.string().min(1, "X/Twitter ct0 is required"),
    TWITTER_AUTH_TOKEN: z.string().min(1, "X/Twitter auth token is required"),
...
export async function validateTwitterConfig(
    ...
    try {
        const twitterConfig = {
            ...
            TWITTER_GUEST_ID:
                runtime.getSetting("TWITTER_GUEST_ID") ||
                process.env.TWITTER_GUEST_ID,
            TWITTER_KDT:
                runtime.getSetting("TWITTER_KDT") ||
                process.env.TWITTER_KDT,
            TWITTER_TID:
                runtime.getSetting("TWITTER_TID") ||
                process.env.TWITTER_TID,
            TWITTER_CT0:
                runtime.getSetting("TWITTER_CT0") ||
                process.env.TWITTER_CT0,
            TWITTER_AUTH_TOKEN:
                runtime.getSetting("TWITTER_AUTH_TOKEN") ||
