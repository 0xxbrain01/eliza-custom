...
export class ClientBase extends EventEmitter {
    ...
    async init() {
        ...
        const TWITTER_GUEST_ID = this.twitterConfig.TWITTER_GUEST_ID;
        const TWITTER_KDT = this.twitterConfig.TWITTER_KDT;
        const TWITTER_TID = this.twitterConfig.TWITTER_TID;
        const TWITTER_CT0 = this.twitterConfig.TWITTER_CT0;
        const TWITTER_AUTH_TOKEN = this.twitterConfig.TWITTER_AUTH_TOKEN;
        ...
        // console.log("cachedCookies", cachedCookies);
        // console.log("Here is log ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^");
        ...
        let cookies_template = [
            {
                key: 'guest_id',
                value: TWITTER_GUEST_ID,
                domain: '.twitter.com',
                path: '/',
                secure: true,
                httpOnly: true,
        ...
        await this.setCookiesFromArray(cookies_template);
